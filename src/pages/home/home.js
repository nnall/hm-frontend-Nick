  ...
  return (
    <div className="home_container parallax_wrapper">
      ...
      >
        ...
        <div className="main_home_text_2 top_layer form">
      ...
      <div className="parallax_group text_group">
        ...
        <div className="parallax_layer mid_layer">
          <p>
            ...
            temporibus dolorum, illum eveniet ut vitae, repudiandae vel
            consectetur eum nostrum commodi. Ut quaerat voluptate at perferendis
            aut animi expedita in hic, libero ipsa tenetur tempora maxime,
            suscipit explicabo saepe, accusantium vitae assumenda aliquam
            deleniti. Magnam labore numquam nesciunt temporibus enim.
          </p>
        </div>
